...
public class VisualizerRemoteCacheManager extends RemoteCacheManager {
   ...
   public static Properties getCacheProperties() {
      ...
      props.setProperty("infinispan.client.hotrod.server_list", System.getProperty("infinispan.visualizer.serverList", "192.168.56.101:11222;192.168.56.101:11322;192.168.56.101:11422"));
      props.setProperty("infinispan.client.hotrod.transport_factory", TRANSPORT_FACTORY);
      return props;
   }
   
   public static void main(String[] args) throws InterruptedException {
	   VisualizerRemoteCacheManager manager = new VisualizerRemoteCacheManager();
	   manager.start();
	   while (true) {
		   Thread.sleep(1);
	   }
